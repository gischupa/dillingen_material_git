...
**Variablen festlegen**  
(Können auch mauell in Umgebungsvariablen geschrieben werden, wenn Sicherheit ein Thema ist. )
...
bash create-user.sh alice 3333 8080
bash create-user.sh bob   3334 8081
